...
| F7 BET B ✅ (GENERALIZED n=3 floors): autonomous floor-crossing + internalized TOOL-USE across mult/count/base (direct 0/6 → plain-prompt tool-use 6/6 each, one multi-task LoRA); raw-skill 0/6 (in executor); sort=honest non-floor. vs RAG-internalization 2510.01375 | ✅ | floor_crossing(+suite) |
